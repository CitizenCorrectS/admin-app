    ...
    <div className="pt-36">
      ...
      <div className="flex justify-center relative my-0 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          <p className="uppercase tracking-widest text-xs text-center text-bold text-gray-600 dark:text-white-100 max-w-80">
          India&apos;s First <span className="text-black dark:text-[#000319] font-outline-2">Carbon</span> Market
          </p>
           ...
           */}
          <TextGenerateEffect
            words="Wealth for you 💵 Health for the planet 🌍"
            className="text-center text-[40px] md:text-5xl lg:text-6xl"
          />
          <div className="mt-12">
          <a href="#about">
                <button
                className="relative inline-block p-px font-semibold leading-6 text-black dark:text-white shadow-2xl cursor-pointer rounded-xl shadow-zinc-900 transition-transform duration-300 ease-in-out hover:scale-105 active:scale-95"
              >
...
//        */}
//       <div
//         className="h-screen w-full dark:bg-[#000319] bg-gray-100 dark:bg-grid-white/[0.03] bg-grid-black-100/[0.2]
//         absolute top-0 left-0 flex items-center justify-center"
//       >
//         {/* Radial gradient for the container to give a faded look */}
//         <div
