...
const NewsLetter = () => {
  return (
    <StyledWrapper>
      <form className="form">
        <div className="form-title"><span>subscribe to</span></div>
        <div className="title-2"><span>CARBON</span></div>
        <div className="form-title"><span>newsletter</span></div>
        ...
        <p className="signup-link">
            Get updates on
            <a className="up" href=""> Carbon Auctions!</a>
        </p>
      </form>
    </StyledWrapper>
  );
