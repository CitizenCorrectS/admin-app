...
const searchParams = useSearchParams()
  ...
  const handleReset = () => {
   ...
   return (
    <main className="grid flex-1 gap-4 w-full overflow-hidden p-4 md:grid-cols-2 lg:grid-cols-3">
        <Leva collapsed={true} titleBar={{ title: "Shadow Analysis", position: { x: -55, y: 100 } }} />
          ...
          <div className="relative flex h-full min-h-[50vh] flex-col rounded-xl bg-muted/50 p-4 lg:col-span-2">
            <div className="relative w-full aspect-[4/3] max-w-[1086px] max-h-[900px] mx-auto">
                <ClientCanvas>
