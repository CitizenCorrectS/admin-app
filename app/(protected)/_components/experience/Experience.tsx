...
import Land from '@/app/(protected)/_components/three/Land';
import Earth from '@/app/(protected)/_components/three/Earth';
// import Cube from '@/components/three/Cube';
// import SunPath from '@/components/three/Sunpath';
import { SunSimulation } from '@/app/(protected)/_components/sun-simulation';
import { useControls } from 'leva';
import { Vector3 } from 'three';
import { useSearchParams } from 'next/navigation';
import Building from '@/app/(protected)/_components/three/Building';
import { useCallback } from 'react';
import { useThree } from '@react-three/fiber';
import ClientCanvas from '../canvas/ClientCanvas';
